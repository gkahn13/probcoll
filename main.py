...
if __name__ == '__main__':
    ...
    parser_probcoll.add_argument('--reset', action='store_true')
    ...
    if run == 'probcoll':
        if robot == 'pointquad':
            ...
            prediction = ProbcollRCcar(server=args.server, username=args.username, password=args.password, reset=args.reset)
